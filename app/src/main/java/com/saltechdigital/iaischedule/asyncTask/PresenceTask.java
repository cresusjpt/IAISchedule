...
public class PresenceTask extends AsyncTask<String, Integer, Boolean> {
    ...
    public PresenceTask(Context context, IdentificationCallback callback) {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        String enreg_url = Task.URL.getNom() + "/" + Task.ENREGFILE.getNom();
